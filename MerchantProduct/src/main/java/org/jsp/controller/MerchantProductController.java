...
public class MerchantProductController {
	...
	public static void findByBrand() {
		...
		String brand = s.next();
		List<Product> prod = pdao.findByBrand(brand);
		if (prod != null) {
			for (Product p : prod) {
	...
	public static void findByMid() {
		System.out.println("Enter Merchant ID");
		int mid= s.nextInt();
		List<Product> prod = pdao.findByMId(mid);
		if (prod != null) {
			for (Product p : prod) {
				System.out.println(p);
			}
	...
	public static void findByCat() {
		System.out.println("Enter Category");
		String cat = s.next();
		List<Product> prod = pdao.findByCat(cat);
		if (prod != null) {
			for (Product p : prod) {
				System.out.println(p);
			}
